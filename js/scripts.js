...
function createNote(id, content, fixed) {
    ...
    const duplicateElement = document.createElement("i");
    duplicateElement.classList.add(...["bi", "bi-file-earmark-plus"]);
    element.appendChild(duplicateElement);
...
function getNotes() {
    ...
    const orderedNotes = notes.sort((a, b) => b.fixed - a.fixed );
